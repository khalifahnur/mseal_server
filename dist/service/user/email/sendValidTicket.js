...
const htmlTemplate = fs_1.default.readFileSync(path_1.default.join(__dirname, "..", "template", "validTicket.html"), "utf8");
const htmlCompiled = handlebars_1.default.compile(htmlTemplate);
const sendTicketValidConfirmation = async (data) => {
    try {
        const templateData = {
            ...data,
...
//# sourceMappingURL=sendValidTicket.js.map