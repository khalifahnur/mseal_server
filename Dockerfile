...
RUN mkdir -p dist/service/staff/template dist/service/user/template dist/service/admin/template && \
    cp -r src/service/staff/template/* dist/service/staff/template/ &&\
    cp -r src/service/user/template/* dist/service/user/template/ &&\
    cp -r src/service/admin/template/* dist/service/admin/template/
